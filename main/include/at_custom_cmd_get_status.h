 ...
 *   AT+GETSTATUSHEX    Query this firmware's status payload as hex
 ...
 *   [0]      proto_ver (M1_ESP32_PROTO_VER)
 *   [1..8]   cmd_bitmap (uint64_t, little-endian, M1_ESP32_CMD_* bits)
 *   [9..40]  fw_name[32] (null-terminated firmware identifier)
 *
 * This allows the M1 host to discover the AT firmware's actual command
